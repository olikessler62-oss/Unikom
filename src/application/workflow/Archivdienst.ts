...
/*
 * Die Frist und die Fristprüfung stehen am **Paket** — siehe `Archivpaket`.
 * Dort steht auch, wann es entstanden ist; der Änderungszeitpunkt der Datei war
 * immer der schwächere Anhaltspunkt, denn wer ein Paket kopiert, setzt ihn neu.
 */
...
export class Archivdienst {
  ...
  /*
   * Fortgeräumt wird nicht mehr hier.
   *
   * Diese Stelle durchsuchte ein Verzeichnis und nahm fort, was auf die
   * Archivendung endete und alt genug war — ohne zu wissen, ob das Paket
   * überhaupt von Unikom stammt und ob sein Lauf durch ist. Beides beantwortet
   * jetzt der Paketbestand; die Bereinigung steht in `Archivbereinigung`.
   */
